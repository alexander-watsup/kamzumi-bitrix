...
$meta = [
    ...
    'files' => [
        ...
        ['path' => 'js/template.js', 'type' => File::TYPE_JAVASCRIPT],
...
unset($meta['properties']['pages-main-blocks']['blocks']['projects']);
unset($meta['properties']['pages-main-blocks']['blocks']['staff']);
unset($meta['properties']['pages-main-blocks']['blocks']['solutions']);
unset($meta['properties']['pages-main-blocks']['blocks']['news']);
unset($meta['properties']['pages-main-blocks']['blocks']['brands']);
...
unset($meta['properties']['sections-articles-template']);
unset($meta['properties']['sections-blog-template']);
