...
<script type="text/javascript">
    (function ($, api) {
        ...
        var messages = {
            'show': '<?= Loc::getMessage('C_CATALOG_SECTION_LIST_CATALOG_TILE_7_TEMPLATE_BUTTON_SHOW') ?>',
            'hide': '<?= Loc::getMessage('C_CATALOG_SECTION_LIST_CATALOG_TILE_7_TEMPLATE_BUTTON_HIDE') ?>'
        };
