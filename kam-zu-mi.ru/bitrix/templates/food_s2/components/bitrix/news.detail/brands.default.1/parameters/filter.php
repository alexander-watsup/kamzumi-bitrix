...
if ($arCurrentValues['FILTER_USE'] === 'Y') {
    ...
    $arTemplateParameters[$sPrefix.'AJAX'] = [
        ...
        'NAME' => Loc::getMessage('C_NEWS_DETAIL_BRANDS_DETAIL_1_'.$sPrefix.'AJAX'),
        'TYPE' => 'CHECKBOX'
    ];

    $arTemplateParameters[$sPrefix.'TYPE'] = [
        'PARENT' => 'FILTER_SETTINGS',
        'NAME' => Loc::getMessage('C_NEWS_DETAIL_BRANDS_DETAIL_1_'.$sPrefix.'TYPE'),
        'TYPE' => 'LIST',
        'VALUES' => [
            'horizontal' => Loc::getMessage('C_NEWS_DETAIL_BRANDS_DETAIL_1_'.$sPrefix.'TYPE_HORIZONTAL'),
            'vertical' => Loc::getMessage('C_NEWS_DETAIL_BRANDS_DETAIL_1_'.$sPrefix.'TYPE_VERTICAL')
        ],
        'REFRESH' => 'Y'
    ];
    ...
    if (!empty($sTemplate)) {
        $arTemplateParameters = ArrayHelper::merge($arTemplateParameters, Component::getParameters(
            ...
            function ($sKey, &$arParameter) {
                ...
                $arParameter['NAME'] = Loc::getMessage('C_NEWS_DETAIL_BRANDS_DETAIL_1_FILTER').'. '.$arParameter['NAME'];
