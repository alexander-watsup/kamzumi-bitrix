...
if (!empty($arIBlock)) {
    ...
    if (!empty($arCurrentValues['PROPERTY_PRICE'])) {
        ...
        $arTemplateParameters['PRICE_OLD_SHOW'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_CATALOG_SERVICES_DEFAULT_1_PRICE_OLD_SHOW'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N',
            'REFRESH' => 'Y'
        ];
        if($arCurrentValues['PRICE_OLD_SHOW']){
            $arTemplateParameters['PROPERTY_PRICE_OLD'] = [
                'PARENT' => 'DATA_SOURCE',
                'NAME' => Loc::getMessage('C_CATALOG_SERVICES_DEFAULT_1_PROPERTY_PRICE_OLD'),
                'TYPE' => 'LIST',
    ...
    if ($arBlocks['banner']['ACTIVE']) {
        ...
        $arTemplateParameters['BLOCKS_BANNER_TITLE_H1'] = [
            'PARENT' => 'DATA_SOURCE',
            'NAME' => Loc::getMessage('C_CATALOG_SERVICES_DEFAULT_1_BLOCKS_BANNER_TITLE_H1'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'Y'
        ];
    ...
    if ($arBlocks['services.1']['ACTIVE']) {
        ...
        $arTemplateParameters['BLOCKS_SERVICES_1_PRICE_OLD_SHOW'] = [
            'PARENT' => 'VISUAL',
            'NAME' => Loc::getMessage('C_CATALOG_SERVICES_DEFAULT_1_BLOCKS_SERVICES_1_PRICE_OLD_SHOW'),
            'TYPE' => 'CHECKBOX',
            'DEFAULT' => 'N',
            'REFRESH' => 'Y'
        ];
        if($arCurrentValues['BLOCKS_SERVICES_1_PRICE_OLD_SHOW']){
            $arTemplateParameters['BLOCKS_SERVICES_1_PRICE_OLD'] = [
                'PARENT' => 'DATA_SOURCE',
                'NAME' => Loc::getMessage('C_CATALOG_SERVICES_DEFAULT_1_BLOCKS_SERVICES_1_PROPERTY_PRICE_OLD'),
                'TYPE' => 'LIST',
                'VALUES' => $arProperties->asArray($hPropertiesString),
                'ADDITIONAL_VALUES' => 'Y'
            ];
