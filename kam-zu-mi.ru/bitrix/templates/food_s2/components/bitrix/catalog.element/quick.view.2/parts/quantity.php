...
$vQuantity = function (&$arItem, $bOffer = false) use (&$arVisual) { ?>
    <?= Html::beginTag('div', [
        'class' => 'catalog-element-quantity-text',
        ...
        <?php if ($arVisual['QUANTITY']['MODE'] === 'number') { ?>
            <span class="catalog-element-quantity-title">
                <?= Loc::getMessage('C_CATALOG_ELEMENT_QUICK_VIEW_2_QUANTITY_TEXT') ?>
            </span>
        <?php } ?>
            ...
            <span class="catalog-element-quantity-value">
                ...
                <?php if ($arVisual['QUANTITY']['MODE'] === 'number') { ?>
                    ...
                    <?php } else if (($arItem['CATALOG_QUANTITY_TRACE'] === 'N' || $arItem['CATALOG_CAN_BUY_ZERO'] === 'Y') && $arItem['CATALOG_QUANTITY'] <= 0 ) { ?>
                        <?= Loc::getMessage('C_CATALOG_ELEMENT_QUICK_VIEW_2_QUANTITY_AVAILABLE') ?>
                    <?php } ?>
        ...
        <?php } else { ?>
            <span class="catalog-element-quantity-value">
                ...
                <?= Loc::getMessage('C_CATALOG_ELEMENT_QUICK_VIEW_2_QUANTITY_UNAVAILABLE') ?>
            </span>
        <?php } ?>
    <?= Html::endTag('div') ?>
<?php };
