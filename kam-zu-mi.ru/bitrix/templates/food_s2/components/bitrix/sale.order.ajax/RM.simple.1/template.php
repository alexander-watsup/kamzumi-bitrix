...
$this->addExternalJs($templateFolder . '/scripts/auto-complete.min.js');
$APPLICATION->SetAdditionalCSS($templateFolder . '/css/auto-complete.css', true);
?>
<noscript>
            ...
            <?php } else { ?>
                            ...
                            <div id="bx-soa-orderSave">
                                <div class="intec-grid intec-grid-i-10 intec-grid-a-v-center intec-grid-nowrap intec-grid-700-wrap">
                                    ...
                                    <div class="intec-grid-item-auto intec-grid-item-700-1">
                                        <a href="javascript:void(0)" style="margin: 10px 0" class="intec-ui intec-ui-control-button intec-ui-mod-round-3 intec-ui-scheme-current intec-ui-size-3" data-save-button="true" id="bx-soa-orderSave__bottomButton">
                                            <?= $arParams['MESS_ORDER'] ?>
                                        </a>
                                    </div>
                                </div>
                ...
                <script>
                    ...
                    BX.Sale.OrderAjaxComponent.init({
                        ...
                        orderSaveBlockId: 'bx-soa-orderSave',
                    });
                </script>
                <script>
                    <?
...
/*
        $(document).ready(function(){
            $('[name="ORDER_PROP_33"]').inputmask({"mask": "+7 (999) 999-9999", autoUnmask:true}); //specifying options
        });
		
        BX.addCustomEvent("onAjaxSuccess", BX.delegate(function(data){		
            $('[name="ORDER_PROP_33"]').inputmask({"mask": "+9 (999) 999-9999", autoUnmask:true});
        }, this));
		
		BX.addCustomEvent("onAjaxFailure", BX.delegate(function(data){			
            $('[name="ORDER_PROP_33"]').inputmask({"mask": "+9 (999) 999-9999", autoUnmask:true});
        }, this));
