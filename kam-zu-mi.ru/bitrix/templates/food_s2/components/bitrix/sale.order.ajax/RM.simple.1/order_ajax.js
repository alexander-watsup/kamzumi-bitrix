...
(function () {
  ...
  BX.Sale.OrderAjaxComponent = {
    ...
    init: function (parameters) {
      ...
      this.orderSaveBlockNode = BX(parameters.orderSaveBlockId);
      this.orderSaveHiddenBlockNode = BX(
        parameters.orderSaveBlockId + "-hidden"
      );
    ...
    getErrorContainer: function (node) {
      ...
      node.appendChild(
        BX.create("DIV", {
          props: {
            className:
              "intec-ui intec-ui-control-alert intec-ui-scheme-red intec-ui-m-b-20",
          },
          style: { display: "none" },
        })
      );
    ...
    showError: function (node, msg, border) {
      ...
      /* CUSTOM */
      var errorContainer = node.querySelector(
    ...
    showErrors: function (errors, scroll, showAll) {
      ...
      var errorNodes = this.orderBlockNode.querySelectorAll(
        "div.intec-ui.intec-ui-control-alert.intec-ui-scheme-red"
      );
    ...
    showBlockErrors: function (node) {
      ...
      /* CUSTOM */
      var errorNode = node.querySelector(
        "div.intec-ui.intec-ui-control-alert.intec-ui-scheme-red"
      );
    ...
    checkNotifications: function () {
      ...
      if (informer) {
        if (
          ...
          BX.addClass(
            informer,
            "intec-ui intec-ui-control-alert intec-ui-scheme-" +
              className +
              " intec-ui-m-b-20"
          );
    ...
    checkBlockErrors: function (node) {
      ...
      if ((hiddenNode = BX(node.id + "-hidden"))) {
        ...
        showWarning = hiddenNode.querySelector(
          "div.intec-ui.intec-ui-control-alert.intec-ui-scheme-orange.alert-show"
        );
    ...
    scrollToError: function () {
      ...
      for (i in sections) {
        if (sections.hasOwnProperty(i)) {
          ...
          /* CUSTOM */
          errorNode = sections[i].querySelector(
            ".intec-ui.intec-ui-control-alert.intec-ui-scheme-red"
          );
    ...
    showWarnings: function () {
      ...
      if (currentDelivery && currentDelivery.CALCULATE_ERRORS) {
        ...
        //this.showBlockWarning(this.orderSaveBlockNode, warningString); //RM210220
    ...
    showBlockWarning: function (node, warnings, hide) {
      ...
      if (errorNode) {
        ...
        /* CUSTOM */
        existedWarningNodes = node.querySelectorAll(
          ".intec-ui.intec-ui-control-alert.intec-ui-scheme-orange"
        );
        ...
        warningNode = BX.create("DIV", {
          ...
          props: {
            className:
              "intec-ui intec-ui-control-alert intec-ui-scheme-orange intec-ui-m-b-20" +
    ...
    markSectionAsCompleted: function (section) {
      ...
      BX.remove(
        section.querySelector(
          ".intec-ui.intec-ui-control-alert.intec-ui-scheme-orange.alert-hide"
        )
      );
    ...
    switchOrderSaveButtons: function (state) {
      var orderSaveNode = this.orderSaveBlockNode,
        ...
        bottomButton = document.querySelector("#bx-soa-orderSave"), //RM
        lastState = this.orderSaveBlockNode.style.display == "";

        if(this.isMobile) {
          console.log("mobile");
          document.querySelector("#bx-soa-orderSave__bottomButton").setAttribute("style", "display: none !important");
        }
        ...
        if (state) {
          ...
          new BX.easing({
            ...
            step: function (state) {
              ...
              if (bottomButton)
                bottomButton.style.opacity = state.opacity / 100;
            },
            complete: function () {
              ...
              bottomButton && bottomButton.removeAttribute("style");
            },
          }).animate();
        } else {
          //console.log('hide'); //RM
          /* ORIGINAL */
          /* Было закомментировано. RM расскомментил */
          ...
          if (bottomButton)
            bottomButton.setAttribute("style", "display: none !important");
        }
      }
    },
    ...
    changeVisibleContent: function () {
      ...
      if (
        ...
        var isVisible = this.shouldBeSectionVisible(
          sections,
          sections.length - 1
        );

        // RM Added 210214
        // Скрывает кнопку доставки, когда не расчитана цена доставки и платёжная система - Сбербанк-Картой
        var curDelivery = this.getSelectedDelivery();
        var deliveryError =
          curDelivery &&
          curDelivery.CALCULATE_ERRORS &&
          curDelivery.CALCULATE_ERRORS.length;

        var curPaySystem = this.getSelectedPaySystem();
        var paySystemError =
          deliveryError && curPaySystem.PSA_ACTION_FILE == "sberbank_ecom2";
        //console.log('pse',paySystemError);
        //console.log(this.isValidPropertiesBlock());

        isVisible = isVisible && !paySystemError;
        this.switchOrderSaveButtons(isVisible);
      }
    },
    ...
    editSection: function (section) {
      ...
      /* CUSTOM */
      errorContainer = section.querySelector(
        ".intec-ui.intec-ui-control-alert.intec-ui-scheme-red"
      );
    ...
    editAuthBlock: function () {
      ...
      if (this.result.OK_MESSAGE && this.result.OK_MESSAGE.length) {
        ...
        okMessageNode = BX.create("DIV", {
          ...
          props: {
            className:
              "intec-ui intec-ui-control-alert intec-ui-scheme-green intec-ui-m-b-20",
          },
        ...
        children: [
          ...
          BX.create("INPUT", {
            props: {
              type: "submit",
              className:
                "intec-ui intec-ui-control-button intec-ui-mod-round-3 intec-ui-scheme-current intec-ui-size-2",
          ...
          children: [
            ...
            BX.create("INPUT", {
              props: {
                type: "submit",
                className:
                  "bx-authform-buttons-register intec-ui intec-ui-control-button intec-ui-mod-round-3 intec-ui-scheme-current intec-ui-size-2",
    ...
    editFadeRegionContent: function (node) {
      ...
      /* CUSTOM */
      var errorNode = this.regionHiddenBlockNode.querySelector(
        ".intec-ui.intec-ui-control-alert.intec-ui-scheme-red"
      );
            ...
            node.appendChild(
              BX.create("DIV", {
                props: {
                  className:
                    "radio-inline" +
                    (currentType.CHECKED == "Y" ? " radio-inline-checked" : ""),
                },
                children: [label],
              })
            );
    ...
    editFadePaySystemContent: function (node) {
      ...
      /* CUSTOM */
      var errorNode = this.paySystemHiddenBlockNode.querySelector(
        "div.intec-ui.intec-ui-control-alert.intec-ui-scheme-red"
      );
      var warningNode = this.paySystemHiddenBlockNode.querySelector(
        "div.intec-ui.intec-ui-control-alert.intec-ui-scheme-orange.alert-show"
      );
    ...
    selectPaySystem: function (event) {
      ...
      if (innerPsAction) {
        ...
        if (BX.hasClass(actionSection, "bx-selected")) {
          if (event.toElement && event.toElement.tagName === "A") return;
    ...
    editDeliveryInfo: function (deliveryNode) {
      ...
      /* CUSTOM */
      var currentDeliveryNode = BX.findChild(
        deliveryNode,
        { className: "bx-soa-pp-company bx-selected" },
        true
      );
      var parametersNode;
      var parametersNodes = BX.findChildren(
        deliveryNode,
        { className: "bx-soa-pp-company-parameters" },
        true
      );
    ...
    editFadeDeliveryContent: function (node) {
      ...
      /* CUSTOM */
      var errorNode = this.deliveryHiddenBlockNode.querySelector(
        "div.intec-ui.intec-ui-control-alert.intec-ui-scheme-red"
      );
      var warningNode = this.deliveryHiddenBlockNode.querySelector(
        "div.intec-ui.intec-ui-control-alert.intec-ui-scheme-orange.alert-show"
      );
    ...
    selectDelivery: function (event) {
      ...
      var target = event.target || event.srcElement,
        /* CUSTOM */
        actionParameters = BX.findParent(target, {
          className: "bx-soa-pp-company-parameters",
        }),
        /* ORIGINAL */
        actionSection = BX.hasClass(target, "bx-soa-pp-company")
    ...
    selectStore: function (event) {
      ...
      if (storeItem && storeInput) {
        ...
        button = BX.findChild(
          selectedPickUp,
          { className: "intec-ui-control-button" },
          true
        );

        if (button) button.text = this.params.MESS_SELECT_PICKUP;
        ...
        if (button) button.text = this.params.MESS_SELECTED_PICKUP;
    ...
    validateString: function (input, arProperty, fieldName) {
      //console.log('validating',input,arProperty);
      ...
      if (arProperty.ID === "33" && value.length > 0) {
        var v = value.replace(/\D/g, "");
        var isPhone = /^\d{11}$/.test(v);
        if (!isPhone) {
    ...
    editTotalBlock: function () {
      ...
      var currentDate = new Date(); //RM
      var currentHour = currentDate.getHours(); //RM
      ...
      if (deliveryError) {
        ...
        /*
				if(currentHour<11||currentHour>=23) {
					document.querySelector('#bx-soa-orderSave .intec-grid-item-shrink-1').innerHTML = "<b class='bx-soa-price-not-calc'>Мы принимаем заказы ежедневно с 11:00 до 22:45. Примем заказ, как только придём на работу!</b>"; //RM2102
				} else {
					document.querySelector('#bx-soa-orderSave .intec-grid-item-shrink-1').innerHTML = "<b class='bx-soa-price-not-calc'>Скорее всего мы сейчас не сможем организовать доставку в ваш адрес!</b>"; //RM2102
				}
				*/
        document.querySelector(
          "#bx-soa-orderSave .intec-grid-item-shrink-1"
        ).innerHTML = `<b class='bx-soa-price-not-calc'>${curDelivery.CALCULATE_DESCRIPTION}</b>`; //RM2105
        //CALCULATE_DESCRIPTION

        //console.log('Delivery Error', curDelivery); //RM
        //this.switchOrderSaveButtons(false);
        //this.disallowOrderSave();
      } else {
        document.querySelector(
          "#bx-soa-orderSave .intec-grid-item-shrink-1"
      ...
      // RM Added 210309 START
      params = { highlighted: true, oneline: true };

      if (currentHour < 11 || currentHour >= 23) {
        this.totalInfoBlockNode.appendChild(
          this.createTotalUnit(
            "Шеф-повар работает ежедневно с 11:00 до 22:45. Сейчас отдыхает.",
            "",
            params
          )
        );
            ...
            children: [
              BX.create("A", {
                props: {
                  href: "javascript:void(0)",
                  className:
                    "intec-ui intec-ui-control-button intec-ui-mod-block intec-ui-mod-round-3 intec-ui-scheme-current intec-ui-size-2 btn-order-save",
                },
    ...
    createTotalUnit: function (name, value, params) {
      ...
      if (params.oneline) {
        return BX.create("DIV", {
          ...
          children: [BX.create("SPAN", { props: {}, text: name })],
        });
      }
      // END
