        ...
        <table class="bx-soa-page-table">
            <tr>
                ...
                <td class="bx-soa-page-table-content">
                    ...
                    <br/><br/>
					<div style="border:solid 3px green;border-radius:5px;padding:15px;font-size:1.5em;border-right:10px solid green;">Администратор позвонит вам, чтобы подтвердить заказ.<br/>Если администратор не позвонил, значит, возможно, мы не получили ваш заказ. В таком случае позвоните +7 (4012) 31-31-02 и убедитесь, что мы начали готовить!</div>
					<br/><br/>
					Будьте внимательны. Мы готовим заказ <b>только</b> после подтверждения по телефону. Администратор перезванивает в течение 15 минут после получения заказа с сайта.
					<br/><br/>
