		...
		editRegistrationForm: function(authContent)
		{
			...
			if (this.result.AUTH.new_user_registration_email_confirmation != 'Y')
			{
                ...
                radioNode.appendChild(
					/* CUSTOM */
                    BX.create('LABEL', {
                        props: {className: 'intec-ui intec-ui-control-radiobox intec-ui-scheme-current', for: 'NEW_GENERATE_N'},
                        children: [
                            BX.create('INPUT', {
							...
							BX.create('SPAN', {props: {className: 'intec-ui-part-selector'}}),
							BX.create('SPAN', {props: {className: 'intec-ui-part-content'}, text: BX.message('STOF_MY_PASSWORD')})
                        ],
                        events: {
                ...
                radioNode.appendChild(
					/* CUSTOM */
                    BX.create('LABEL', {
                        props: {className: 'intec-ui intec-ui-control-radiobox intec-ui-scheme-current', for: 'NEW_GENERATE_Y'},
                        children: [
                            BX.create('INPUT', {
                                attrs: {checked: this.authGenerateUser},
                                props: {
                            ...
                            BX.create('SPAN', {props: {className: 'intec-ui-part-selector'}}),
                            BX.create('SPAN', {props: {className: 'intec-ui-part-content'}, text: BX.message('STOF_SYS_PASSWORD')})
                        ],
                        events: {
                            change: BX.delegate(function(){
                                var generated = this.authBlockNode.querySelector('.generated');
