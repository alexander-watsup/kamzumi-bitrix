...
$arQuickView['DETAIL'] = $arQuickView['USE'] && $arParams['QUICK_VIEW_DETAIL'] === 'Y';$arQuickView['SLIDE']['USE'] = $arQuickView['USE'] && $arParams['QUICK_VIEW_SLIDE_USE'] === 'Y';$arQuickView['SLIDE']['USE'] = $arQuickView['USE'] && $arParams['QUICK_VIEW_SLIDE_USE'] === 'Y';
