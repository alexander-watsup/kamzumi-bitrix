                        ...
                        <div class="widget-sections">
                            <?php foreach ($arResult['CATEGORIES'] as $arCategory) { ?>
                                <div class="widget-section">
									<? if($arCategory['NAME']=="Роллы") { ?>
									<div class="widget-section-name intec-template-part intec-template-part-title" data-align="center">
										<img src="/images/icons/rolly.png" width="80"/> Роллы
									<div>
									<? } elseif($arCategory['NAME']=="Суши") { ?>
									<div class="widget-section-name intec-template-part intec-template-part-title" data-align="center">
										<img src="/images/icons/sushi.png" width="80"/> Суши
									</div>
									<? } elseif ($arVisual['SECTIONS']['TITLE']['SHOW']) { ?>
