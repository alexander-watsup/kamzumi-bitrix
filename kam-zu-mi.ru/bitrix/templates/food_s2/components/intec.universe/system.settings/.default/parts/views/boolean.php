...
return function ($sKey, $arProperty) { ?>
    <div class="system-settings-property-value">
        <label class="system-settings-property-value-parts intec-grid intec-grid-nowrap intec-grid-i-h-10 intec-grid-a-v-center">
            <div class="system-settingsp-property-value-part intec-grid-item-auto">
            ...
            <?php if ($arProperty['title'] === 'inner') { ?>
                ...
                <div class="system-settings-property-value-part intec-grid-item intec-grid-item-shrink-1">
