...
if (!Loader::includeModule('intec.food')) {
    echo Loc::getMessage('template.errors.module', ['#MODULE#' => 'intec.food']);
    die();
}
...
$properties
    ...
    ->setRange([
        ...
        $page->getProperties()->get('template-menu-show') &&
            ...
            !empty($menu->arMenu),
        'base-settings-show' => IntecFood::SettingsDisplay(null, SITE_ID),
        'yandex-metrika-use' => IntecFood::YandexMetrikaUse(null, SITE_ID),
        'yandex-metrika-id' => IntecFood::YandexMetrikaId(null, SITE_ID),
        'yandex-metrika-click-map' => IntecFood::YandexMetrikaClickMap(null, SITE_ID),
        'yandex-metrika-track-hash' => IntecFood::YandexMetrikaTrackHash(null, SITE_ID),
        'yandex-metrika-track-links' => IntecFood::YandexMetrikaTrackLinks(null, SITE_ID),
        'yandex-metrika-track-webvisor' => IntecFood::YandexMetrikaWebvisor(null, SITE_ID)
    ]);
