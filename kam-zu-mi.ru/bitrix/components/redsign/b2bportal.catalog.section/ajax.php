...
try
{
	$template = $signer->unsign($request->get('template') ?: '', 'b2bportal.catalog.section') ?: '.default';
	$paramString = $signer->unsign($request->get('parameters') ?: '', 'b2bportal.catalog.section');
}
